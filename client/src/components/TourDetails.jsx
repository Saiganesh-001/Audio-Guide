...
const TourDetails = () => {
	...
	const handleBuyNow = () => {
        ...
        toast.success("Audio Purchased Successfully")
		setBuyStatus(true);
	};
				...
				<div className="flex justify-between mt-5 rounded-md min-h-[45vh]">
					...
					<div className="flex flex-col min-w-[20vw] shadow-lg rounded-md">
						...
						<div className="min-h-[13vh] pl-3 rounded-md max-w-[19vw]">
							{buyStatus ? (
								<div className="text-2xl font-semibold text-[#3d4852] mb-3 flex items-center gap-2">
                                    <div><BiSolidPurchaseTagAlt /></div>
                                    <div>Purchased</div>
                                </div>
							) : (
								<div className="text-4xl font-semibold text-[#273D52] mb-3">
									₹{data?.price}
								</div>
							)}
